    ...
    const getNowPlayingMovies = async () => {
        try{
            const responses = await Promise.all([
                fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=2a5e286bb1bdc7c0bf49d7b6d0707880&language=en-US&page=${page}`),
    ...
    return(
        <main>
           ...
           <div className='row'>
            ...
            <h4 className='mb-4'>Now Playing</h4>
